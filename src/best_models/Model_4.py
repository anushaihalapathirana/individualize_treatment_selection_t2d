...
class Model4(BaseModel):
    def __init__(self): 
        feature_list = ['C10A', 'MD_RCT_mmol_mol', 'P_Krea', 'T2D_nocomp', 'bmi', 'comb_comp_enn', 'drug_class', 'eGFR', 'gluk', 
                        'hba1c_bl_18m', 'hba1c_bl_6m', 'hdl', 'ika', 'insulin', 'ldl', 'met_oad0', 'n_of_dis', 'renal_insuf', 
                        'smoking', 'sum_diab_drugs', 't2d_dur_y', 'trigly']
