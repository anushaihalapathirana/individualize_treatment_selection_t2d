...
from constants import X_TRAIN_PATH, COMMON_VARIABLE_PATH, HBA1C_PATH, SEED
...
class ImputationHbA1c:
    ...
    def preprocess(self, df, test_size):
        ...
        """Further preprocess data (Focusing response variable as Hba1c)
        ...
        Returns: 
            ...
            df_missing_val, df_missing_val_original : dataframes with missing values of Hba1c_12m
            df_original : original dataframe
        """
        
        print('Shape of data :', np.shape(df))
        
        df_missing_val = df[df['hba1c_12m'].isnull()]
