...
from constants import X_TRAIN_PATH, COMMON_VARIABLE_PATH, HDL_PATH, SEED
...
class ImputationHDL:
    ...
    def preprocess(self, df, test_size):
        ...
        """Further preprocess data (Focusing response variable as HDL)
        ...
        Returns: 
            ...
            df_missing_val, df_missing_val_original : dataframes with missing values of hdl_12m
            df_original : original dataframe
        """
        
        print('Shape of data :', np.shape(df))
        
        df_missing_val = df[df['hdl_12m'].isnull()]
        ...
        # Remove samples with hdl greater than 5
